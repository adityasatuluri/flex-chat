...
import { bgThemes, textThemes } from "@/lib/utils";
...
const ProfileInfo = () => {
  ...
  return (
    <div className={`absolute bottom-0 h-20 flex items-center justify-between px-10 w-full ${bgThemes[3]}`}>
        ...
        <TooltipProvider>
            <Tooltip>
                <TooltipTrigger>
                <FiEdit2 className={`${textThemes[0]} text-xl font-medium`}
